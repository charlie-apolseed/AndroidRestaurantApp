...
data class RestaurantItem(
    ...
    @ColumnInfo(name = "restaurant_food_rating") val restaurantFoodRating: Int,
    @ColumnInfo(name = "restaurant_vibes_rating") val restaurantVibesRating: Int,
    @ColumnInfo(name = "restaurant_staff_rating") val restaurantStaffRating: Int,
    @ColumnInfo(name = "restaurant_price_rating") val restaurantPriceRating: Int,
